...
const Footer: React.FC<FooterProps> = ({ webshopName = "TechNest" }) => {
      ...
      <Container maxWidth="lg">
              ...
              <Box sx={{ mb: 4 }}>
                ...
                <Stack spacing={2} sx={{ mb: 3 }}>
                  <Typography variant="body1">
                    <Link
                      href={`mailto:contact@${webshopName
                        .toLowerCase()
                        .replace(/\s+/g, "")}.com`}
                      color="inherit"
                      underline="hover"
                    >
                      ...
                      contact@{webshopName.toLowerCase().replace(/\s+/g, "")}
                      .com
                    </Link>
                  </Typography>
                </Stack>
        ...
        >
          <Typography variant="body2">
            © {new Date().getFullYear()} {webshopName}. All rights reserved.
          </Typography>
        </Box>
      </Container>
    </Box>
